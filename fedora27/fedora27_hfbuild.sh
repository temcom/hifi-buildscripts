#
# Build script for High Fidelity VR Platform - Fedora 27 edition.
...
# make files (a routine occurence) and certain packages being at certain level in Fedora 27 (not
# an assured proposition since is still in pre-release stages -- it just so happens that
